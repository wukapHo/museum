...
import { setProgressSliders } from './video-player.js';
import { setPlaylistSlider } from './video-slider.js';
import { setVideoPlayer } from './video-player.js';
import { setGallery } from './gallery.js';
import { viewImages } from './gallery.js';
import { calcTickets } from './tickets-calc.js';
import { viewTicketsPopup } from './booking-tickets.js';
import { calcTicketsForm } from './form-calc.js';
...
console.log(`
  ...
  + Слайдер в секции Video +19
    ...
    + при перелистывании слайдов буллет активного слайда подсвечивается (выделяется стилем) +2
    +/- если основное видео проигрывалось при перелистывании слайдера, проигрывание видео останавливается, прогресс бар сдвигается к началу, иконки "Play" на панели управления и по центру видео меняются на первоначальные +1
    + даже при частых кликах или свайпах нет ситуации, когда слайд после перелистывания находится не по центру, нет ситуации, когда видны одновременно два слайда +2
  ...
  + Калькулятор продажи билетов в форме продажи билетов +10
